...
Load `dev/autonomous/skills/prd-to-json/SKILL.md` and follow its workflow to convert the PRD to `dev/autonomous/prd.json`. Use the PRD you just created at `dev/prds/{feature-name}/prd.md`.
...
- **prd-to-json skill**: `dev/autonomous/skills/prd-to-json/SKILL.md`
