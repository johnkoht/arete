...
updated: 2026-02-25T03:20:22.646Z
completed: null
execution: null
has_review: false
...
## Size Estimate
**Medium** (5 distinct steps across 3 phases)
...
**Recommendation**: This is medium-sized but low-risk. The work is additive (new skill, new pattern) not disruptive. I'd suggest `/pre-mortem` is optional here — the main risk is "does the template structure serve the use case" which we can validate by comparing to glance-comms.

Want me to refine any part of this plan before you take it to the worktree?