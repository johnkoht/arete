...
// ---------------------------------------------------------------------------
export function resolveTargetSlugs(
  positional: string | undefined,
  slugsFlag: string | undefined,
...
export function registerTopicCommands(program: Command): void {
  ...
  topicCmd
    ...
    .action(async (
      ...
      const slugs = resolved === 'all' ? undefined : (resolved as string[]);
  ...
  topicCmd
    ...
    .action(async (
      ...
      let result: { slug: string; aliases: string[]; added: string[]; changed: boolean };
      try {
      ...
      if (refreshed !== undefined) {
        const r = refreshed as { integrated?: number };
