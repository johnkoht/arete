 ...
 */
import { createServices, loadConfig, refreshQmdIndex, renderTemplateString, } from '@arete/core';
import { join } from 'node:path';
import { header, success, error, info, listItem, } from '../formatters.js';
...
export function registerCreateCommands(program) {
    ...
    createCmd
        ...
        if (!meetingTitle) {
            ...
            areaContent = areaContent.replace(/recurring_meetings:\n  - title: "Weekly Sync"\n    attendees: \[\]\n    frequency: weekly\n/, 'recurring_meetings: []\n');
        }
