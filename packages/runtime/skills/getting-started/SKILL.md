...
Start with a warm welcome, then ask 3 focused questions.

### Opening

```
I'll help you set up your workspace. This takes about 15-20 minutes.
Let me ask a few quick questions to customize your experience.
```

---

### Q0: Identity *(skip if profile.md exists with real values)*
...
*Check `context/profile.md`. If exists with real values, greet by name and skip to Q1.*
...
```
What can we connect right now?

1. Calendar (meetings scheduled)
2. Meeting recordings (Fathom, Grain)
3. Existing docs to paste
4. Nothing yet - starting fresh
...
```
What would make today valuable?

1. Prep for an upcoming meeting
2. Plan my week
3. Capture existing context
4. Just explore - show me around
...
1. Yes, let's go
2. I need to gather some materials first
3. Just give me a quick tour
...
Based on discovery answers, route deterministically:

### Path Routing Table

| Q1 | Q2 | Q3 | Route to |
|----|----|----|----------|
| Has calendar (1) | Meeting prep (1) | Ready (1) | **Meeting-first**: Calendar → meeting-prep |
| Any | Plan week (2) | Ready (1) | **Planning-first**: week-plan → now/week.md |
| Has docs (3) | Capture context (3) | Ready (1) | **Context-first**: guided input |
| Nothing (4) | Explore (4) | Any | **Tour**: workspace-tour |
| Any | Any | Not ready (2) | **Pause**: explain next steps, offer to continue later |
| Any | Any | Quick tour (3) | **Tour**: workspace-tour |

### Path Routing Logic (Fallback)

| Q1 Answer | Q2 Answer | Route to |
|-----------|-----------|----------|
| Has calendar (1) | Meeting prep (1) | **Path C** → meeting-prep |
| Has docs (3) | Capture context (3) | **Path A** |
| Any | Plan week (2) | **Path B** → week-plan |
| Nothing (4) | Any | **Path B** |
| Any | Explore (4) | **Tour**: workspace-tour |
