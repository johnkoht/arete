 ...
 */
export function applyAddCreatedAt(commitments) {
    const entries = [];
 ...
 */
export function parseCommitmentsFile(content) {
    if (content === null)
        return [];
    try {
 ...
 */
export function serializeCommitmentsFile(commitments) {
    const file = { commitments };
 ...
 */
export function migrateAddCreatedAt(rawJson) {
...
//# sourceMappingURL=add-created-at.js.map