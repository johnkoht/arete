 ...
 */
export declare function loadRecentMeetingBatch(storage: StorageAdapter, meetingsDir: string, days?: number, excludePath?: string): Promise<MeetingExtractionBatch[]>;
