 ...
 */
function parseGoalFile(content, filePath) {
 ...
 */
function extractQuarter(content) {
 ...
 */
function parseFormatA(content, quarter, goalsDir) {
    const goals = [];
 ...
 */
function parseFormatB(content, goalsDir) {
    const goals = [];
    let match;
 ...
 */
async function parseLegacyQuarterFile(goalsDir, storage) {
 ...
 */
async function parseIndividualGoals(goalsDir, storage) {
 ...
 */
export async function parseGoals(goalsDir, storage) {
...
//# sourceMappingURL=goal-parser.js.map