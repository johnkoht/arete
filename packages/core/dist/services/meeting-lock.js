 ...
 */
import { access, writeFile, stat, rename } from 'node:fs/promises';
...
function serializeFrontmatterBlock(data, body) {
...
// ---------------------------------------------------------------------------
async function ensureMeetingLockTarget(filePath) {
    try {
...
// ---------------------------------------------------------------------------
async function atomicWriteViaStorage(storage, filePath, content) {
 ...
 */
export async function writeWithLock(storage, meetingPath, mutator, options = {}) {
...
//# sourceMappingURL=meeting-lock.js.map