 ...
 */
export function generateSkillCommand(skill) {
    const lines = [];
    ...
    if (skill.profile) {
        lines.push(`Adopt the voice and approach described in \`.agents/profiles/${skill.profile}.md\` while executing this skill.`);
        lines.push('');
    }
 ...
 */
export function generateAllSkillCommands(skills) {
    const result = {};
