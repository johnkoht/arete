...
function parseExtractionResponse(response) {
    ...
    if (Array.isArray(raw.stakeholders) && raw.stakeholders.length > 0) {
        ...
        if (insights.stakeholders.length === 0)
            delete insights.stakeholders;
    }
 ...
 */
export async function extractInsights(conversationText, callLLM) {
