...
function summarizeStrategy(facts) {
    if (facts.length === 0) {
...
function buildChecklist(hasWebsite, hasFolder, hasPaste) {
    const checks = [
...
export function buildContextDumpArtifacts(inputs) {
...
export function buildContextDumpQualityReport(inputs) {
...
//# sourceMappingURL=context-dump-quality.js.map