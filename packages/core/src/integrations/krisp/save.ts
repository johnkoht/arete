...
import type { KrispMeeting, KrispMeetingNotes, KrispTranscriptSegment } from './types.js';
 ...
 */
function resolveNotes(meeting: KrispMeeting): KrispMeetingNotes {
  const notes = (typeof meeting.meeting_notes === 'object' && meeting.meeting_notes !== null)
    ? meeting.meeting_notes as KrispMeetingNotes
    : {};
  return {
