...
/**
 * Auto-generated header prepended to all transpiled rules
 */
const AUTO_GENERATED_HEADER = '<!-- AUTO-GENERATED by Areté — edit canonical source in runtime/rules/, not this file -->\n\n';
...
export function transpileRule(
  ...
  const finalContent = AUTO_GENERATED_HEADER + transformed;
