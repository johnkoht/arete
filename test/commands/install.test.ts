...
describe('install command', () => {
  ...
  describe('multi-IDE support', () => {
    describe('Cursor target (default behavior)', () => {
      ...
      it('transpiles rules to .mdc format with auto-generated header', async () => {
        await installCommand(tmpDir, { json: true, ide: 'cursor' });
        ...
        assert.ok(
          sampleRule.startsWith('<!-- AUTO-GENERATED by Areté'),
          'Rule should have auto-generated header'
        );

        // Verify YAML frontmatter format (---\n...\n---\n)
        assert.ok(
          sampleRule.includes('---\n'),
          'Rule should have YAML frontmatter'
        );
      });
    ...
    describe('Claude target', () => {
      ...
      it('transpiles rules to .md format with auto-generated header', async () => {
        await installCommand(tmpDir, { json: true, ide: 'claude' });
