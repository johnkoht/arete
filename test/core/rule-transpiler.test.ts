  ...
  describe('transpileRule', () => {
    describe('CursorAdapter', () => {
      ...
      it('includes auto-generated header', () => {
        ...
        // Should start with auto-generated header
        assert.ok(result.content.startsWith('<!-- AUTO-GENERATED by Areté'));
      });
    ...
    describe('with CursorAdapter', () => {
      ...
      it('transpiles all rules in allowList', () => {
        ...
        for (const ruleFile of PRODUCT_RULES_ALLOW_LIST) {
          ...
          // Verify content has auto-generated header
          const content = readFileSync(expectedPath, 'utf-8');
          assert.ok(content.startsWith('<!-- AUTO-GENERATED by Areté'));
        }
      });
