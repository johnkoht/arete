...
<!-- Generated by build-agents.ts at 2026-02-14T20:53:10.528Z -->
...
|arete-vision.mdc:Product philosophy — "Does it help the product builder achieve arete?" Guides all feature and design decisions.
...
|agent-memory.mdc:Memory management for AI agents building Areté: memory locations (entries, collaboration.md, MEMORY.md), when to create entries, when to synthesize collaboration profile, how to leverage build memory before starting work.
